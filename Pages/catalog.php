...
<body>
    ...
    <main>
      <div class="dropdown">
        <button class="btn btn-secondary dropdown-toggle" style="display: inline-block;" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
          Отфильтровать по:
        </button>
...
<br>
        ...
        while($row= $result->fetch_assoc())
    {
      if ($row['Count'] >= 1) {
        ...
        echo '<a href ="itemInfo.php?ID= '.$row['ID'].'">Подробнее</a>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
    }
